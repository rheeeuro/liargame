const words = [
  ...
  { word: "날씨의 아이", category: "영화" },
  { word: "괴물", category: "영화" },
  { word: "신과함께", category: "영화" },
  { word: "범죄도시", category: "영화" },
  { word: "미션임파서블", category: "영화" },
  { word: "겨울왕국", category: "영화" },
  { word: "라푼젤", category: "영화" },
  { word: "극한직업", category: "영화" },
  { word: "베테랑", category: "영화" },
  { word: "태극기휘날리며", category: "영화" },
  { word: "7번방의선물", category: "영화" },
  { word: "부산행", category: "영화" },
  { word: "해운대", category: "영화" },
  { word: "기생충", category: "영화" },
  { word: "인터스텔라", category: "영화" },
  { word: "설국열차", category: "영화" },
  { word: "아이언맨", category: "영화" },
  { word: "국가대표", category: "영화" },
  { word: "스파이더맨", category: "영화" },
  { word: "타이타닉", category: "영화" },
  { word: "스타워즈", category: "영화" },
  { word: "쥬라기공원", category: "영화" },
  { word: "라이온킹", category: "영화" },
  { word: "분노의 질주", category: "영화" },
  { word: "탑건", category: "영화" },
  { word: "블랙팬서", category: "영화" },
  { word: "미니언즈", category: "영화" },
  { word: "캡틴아메리카", category: "영화" },
  { word: "조커", category: "영화" },
  { word: "토이스토리", category: "영화" },
  { word: "알라딘", category: "영화" },
  { word: "니모를찾아서", category: "영화" },
  { word: "주토피아", category: "영화" },
  { word: "박물관이살아있다", category: "영화" },
  { word: "인사이드아웃", category: "영화" },
  { word: "라따뚜이", category: "영화" },
  { word: "월E", category: "영화" },
  { word: "업", category: "영화" },
  { word: "빅 히어로", category: "영화" },
  { word: "닥터스트레인지", category: "영화" },
  { word: "셜록홈즈", category: "영화" },
  { word: "오페라의유령", category: "영화" },
  { word: "몬스터주식회사", category: "영화" },
  { word: "테이큰", category: "영화" },
  { word: "존윅", category: "영화" },
  { word: "나니아연대기", category: "영화" },
  { word: "나우 유 씨 미", category: "영화" },
  { word: "혹성탈출", category: "영화" },
  { word: "원티드", category: "영화" },
  { word: "투모로우", category: "영화" },
  { word: "마션", category: "영화" },
  { word: "맨인블랙", category: "영화" },
  { word: "아일랜드", category: "영화" },
  { word: "쿵푸팬더", category: "영화" },
  { word: "레미제라블", category: "영화" },
  { word: "인셉션", category: "영화" },
  { word: "천공의 성 라퓨타", category: "영화" },
  { word: "마루 밑 아리에티", category: "영화" },
  { word: "보헤미안 랩소디", category: "영화" },
  { word: "오펜하이머", category: "영화" },
  { word: "메멘토", category: "영화" },
  { word: "인시디어스", category: "영화" },
  { word: "링", category: "영화" },
  { word: "어바웃 타임", category: "영화" },
  /**
   * 음식
   */
  ...
  { word: "고양이", category: "동물" },
  { word: "강아지", category: "동물" },
  { word: "거북이", category: "동물" },
  { word: "토끼", category: "동물" },
  { word: "뱀", category: "동물" },
  { word: "사자", category: "동물" },
  { word: "호랑이", category: "동물" },
  { word: "표범", category: "동물" },
  { word: "치타", category: "동물" },
  { word: "하이에나", category: "동물" },
  { word: "기린", category: "동물" },
  { word: "코끼리", category: "동물" },
  { word: "코뿔소", category: "동물" },
  { word: "하마", category: "동물" },
  { word: "악어", category: "동물" },
  { word: "펭귄", category: "동물" },
  { word: "부엉이", category: "동물" },
  { word: "올빼미", category: "동물" },
  { word: "곰", category: "동물" },
  { word: "돼지", category: "동물" },
  { word: "소", category: "동물" },
  { word: "닭", category: "동물" },
  { word: "독수리", category: "동물" },
  { word: "타조", category: "동물" },
  { word: "고릴라", category: "동물" },
  { word: "오랑우탄", category: "동물" },
  { word: "침팬지", category: "동물" },
  { word: "원숭이", category: "동물" },
  { word: "코알라", category: "동물" },
  { word: "캥거루", category: "동물" },
  { word: "고래", category: "동물" },
  { word: "상어", category: "동물" },
  { word: "이구아나", category: "동물" },
  { word: "칠면조", category: "동물" },
  { word: "쥐", category: "동물" },
  { word: "앵무새", category: "동물" },
  { word: "스라소니", category: "동물" },
  { word: "판다", category: "동물" },
  { word: "오리", category: "동물" },
  { word: "거위", category: "동물" },
  { word: "백조", category: "동물" },
  { word: "고슴도치", category: "동물" },
  { word: "두더지", category: "동물" },
  { word: "너구리", category: "동물" },
  { word: "개구리", category: "동물" },
  { word: "두꺼비", category: "동물" },
  { word: "카멜레온", category: "동물" },
  { word: "노루", category: "동물" },
  { word: "제비", category: "동물" },
  { word: "까치", category: "동물" },
  { word: "고라니", category: "동물" },
  { word: "수달", category: "동물" },
  { word: "당나귀", category: "동물" },
  { word: "순록", category: "동물" },
  { word: "염소", category: "동물" },
  { word: "공작", category: "동물" },
  { word: "바다표범", category: "동물" },
  { word: "들소", category: "동물" },
  { word: "박쥐", category: "동물" },
  { word: "참새", category: "동물" },
  { word: "물개", category: "동물" },
  { word: "바다사자", category: "동물" },
  { word: "구렁이", category: "동물" },
  { word: "얼룩말", category: "동물" },
  { word: "멧돼지", category: "동물" },
  { word: "도롱뇽", category: "동물" },
  { word: "북극곰", category: "동물" },
  { word: "퓨마", category: "동물" },
  { word: "미어캣", category: "동물" },
  { word: "딱따구리", category: "동물" },
  { word: "기러기", category: "동물" },
  { word: "비둘기", category: "동물" },
  { word: "스컹크", category: "동물" },
  { word: "돌고래", category: "동물" },
  { word: "까마귀", category: "동물" },
  { word: "매", category: "동물" },
  { word: "낙타", category: "동물" },
  { word: "여우", category: "동물" },
  { word: "사슴", category: "동물" },
  { word: "늑대", category: "동물" },
  { word: "재규어", category: "동물" },
  { word: "알파카", category: "동물" },
  { word: "양", category: "동물" },
  { word: "다람쥐", category: "동물" },
  { word: "개미핥기", category: "동물" },
];
